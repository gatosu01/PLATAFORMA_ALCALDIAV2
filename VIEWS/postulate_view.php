...
<main>
    <section class="postulate-form">
        <div class="cuadroblanco">
            ...
            <form action="../PHP/postulate_process.php" method="POST" enctype="multipart/form-data">
                ...
                <select name="departamento" id="departamento" required>
                    ...
                    <?php
                    $result = $conexion->query("SELECT id, nombre FROM departament WHERE estado='activo'");
...
<script src="../JS/subdepartament.js"></script>
<!-- Alertify JS -->
...
<?php 
    unset($_SESSION['postulacion_error']);
endif; ?>
